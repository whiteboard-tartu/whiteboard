...
def touch(filename, times=None, create_dirs=False):
    """
    ...
    Keyword Arguments:
        times {set} -- This is the file access and modified time.
                    If the time is none, then the file access and modified times
                    are set to the current time. The parameter times consist of row
                    in the form of (atime, mtime)  (default: {None})
        create_dirs {bool} -- [description] (default: {False})
    """
    if create_dirs:
